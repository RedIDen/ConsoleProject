...
public class CommandHandler : CommandHandlerBase
{
    ...
    public override void Handle(AppCommandRequest appCommandRequest)
    {
        ...
        {
            CommandHandler.PrintMissedCommandInfo(command);
        }
    }
    ...
    private static void Find(string parameters)
    {
        ...
        CommandHandler.ShowRecords(foundRecords, "No records found.");
    }
        ...
        out char favLetter)
    {
        ...
        firstName = ReadInput(CommandHandler.StringConverter, Program.fileCabinetService.Validator.FirstNameValidator);

        Console.Write("Last name: ");
        lastName = ReadInput(CommandHandler.StringConverter, Program.fileCabinetService.Validator.LastNameValidator);

        Console.Write("Date of birth: ");
        dateOfBirth = ReadInput(CommandHandler.DateConverter, Program.fileCabinetService.Validator.DateOfBirthValidator);

        Console.Write("Work experience: ");
        workExperience = ReadInput(CommandHandler.ShortConverter, Program.fileCabinetService.Validator.WorkExperienceValidator);

        Console.Write("Balance: ");
        balance = ReadInput(CommandHandler.DecimalConverter, Program.fileCabinetService.Validator.BalanceValidator);

        Console.Write("Favorite letter: ");
        favLetter = ReadInput(CommandHandler.CharConverter, Program.fileCabinetService.Validator.FavLetterValidator);
    }
    ...
    private static void List(string parameters)
    {
        ...
        CommandHandler.ShowRecords(list, "The list is empty.");
    }
